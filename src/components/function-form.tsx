...
export function FunctionForm({
  ...
  const handleClear = () => {
    ...
    fn.params.forEach((p) => (emptyValues[p.name] = ""));
    ...
    >
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-transparent border border-neutral-700 text-neutral-300 rounded text-xs font-medium disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Clear
        </button>
      </div>
